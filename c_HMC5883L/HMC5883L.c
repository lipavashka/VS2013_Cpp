...
Source: http://www.sparkfun.com/tutorial/Barometric/BMP085_Example_Code.pde
 ...
 // not working Compile with: gcc -Wall -o testBMP085 ./smbus.c ./testBMP085.c
 try this: Compile with: gcc ./smbus.c ./BMP085.c -Wall -o BMP085
